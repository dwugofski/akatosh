...
<?php $zombie_mob = [
	...
	'feats' => ['attributes' => [
		['ano' => true, 'type' => "ano", 'name' => "Undead Fortitude", 'text' => "If damage reduces the zombie to 0 hit points, it must make a <b class=\"die save com\">CON</b> saving throw with a DC of 5 + the damage taken, unless the damage is radiant or from a critical hit. On a success, the zombie drops to 1 hit point instead."]
	]],
	'actions' => ['attributes' => [
