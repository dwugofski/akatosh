<?php $lesserrestoration_spell = [
	...
	'description' => ['attributes' => [
		['par' => true, 'type' => "par", 'text' => "You touch a creature and can end either one disease or one condition afflicting it. The condition can be blinded, deafened, paralyzed, or poisoned."]
	]],
]; ?>