function armsofhadar() {
	var spell = {
		...
		description: {attributes: [
			{par: true, type: "par", text: "You invoke the power of Hadar, the Dark Hunger. Tendrils of dark energy erupt from you and batter all creatures within 10 feet of you. Each creature in that area must make a <b class=\"die save str\">STR</b> saving throw. On a failed save, a target takes <b class=\"die dmg necro\">2d6</b> necrotic damage and canâ€™t take reactions until its next turn. On a successful save, the creature takes half damage, but suffers no other effect. "}
		]},
		higher: {attributes: [
