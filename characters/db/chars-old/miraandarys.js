	...
	var character = {
		...
		features: {feat_sects: [
			...
			{section: "Class Features: Rogue Assassin Archetype", attributes: [
				...
				{ano:true, type:"ano", name:"Assassinate", text: "Starting at 3rd level, you are at your deadliest when you get the drop on your enemies. You have advantage on attack rolls against any creature that hasn&rsqo;t taken a turn in the combat yet. In addition, any hit you score against a creature that is surprised is a critical hit."}
			]}
		]},
		atks: {attributes: [
